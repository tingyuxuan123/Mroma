...
import type { EnvironmentCheckResult, RuntimeStatus } from '@mroma/shared'
import {
  SettingsSection,
  SettingsCard,
  SettingsRow,
...
const GITHUB_RELEASES_URL = 'https://github.com/tingyuxuan123/Mroma/releases'
...
function UpdateCard(): React.ReactElement | null {
  ...
  const [release, setRelease] = React.useState<import('@mroma/shared').GitHubRelease | null>(null)
    ...
    >
      <SettingsCard>
        ...
        <SettingsRow label="项目地址">
          <a
            href="https://github.com/tingyuxuan123/Mroma.git"
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm text-primary hover:underline"
          >
            github.com/tingyuxuan123/Mroma
          </a>
        </SettingsRow>
      </SettingsCard>
