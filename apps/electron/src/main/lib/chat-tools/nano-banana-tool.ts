 ...
 * 支持文生图、参考图编辑、多轮连续修改。
 * 凭据存储在 ~/.mroma/chat-tools.json 的 toolCredentials 中。
 */

import type { ToolCall, ToolResult, ToolDefinition } from '@mroma/core'
import type { ChatToolMeta, FileAttachment } from '@mroma/shared'
